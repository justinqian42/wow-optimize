    ...
    public class MainForm : Form {
        ...
        public MainForm() {
            ...
            settingsMap = new Dictionary<string, SettingItem>() {
                ...
                { "DBC Fast RLE / Copy Unpack", new SettingItem("UI_Lua", "DbcFastRle", false, null, "Optimizes DBC string and integer array unrolling in sub_4CFBB0 with 16-byte aligned vector copies and precomputed offsets.", true) },
